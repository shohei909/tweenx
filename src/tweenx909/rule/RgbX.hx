...
class RgbX {
	...
	static public function calc(from:RgbX, to:RgbX, t1:Float, t2:Float, tween:TweenX):Int {
	...
	static public function defaultFrom( value:Int, to:RgbX, tween:TweenX ):RgbX { 
