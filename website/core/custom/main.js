...
core_output_OutputManager.prototype = {
	getString: function() {
		...
		case 1:
			...
			var bodyExpr = tweenxcore_expr_ComplexEasingKindTools.toExpr(easing,{ expr : haxe_macro_ExprDef.EConst(haxe_macro_Constant.CIdent("value")), pos : { file : "src/core/output/OutputManager.hx", min : 969, max : 974}});
			return print.printExpr({ expr : haxe_macro_ExprDef.EFunction("customEase",{ args : [{ name : "value", opt : false, type : haxe_macro_ComplexType.TPath({ pack : [], name : "Float", params : []})}], ret : haxe_macro_ComplexType.TPath({ pack : [], name : "Void", params : []}), expr : { expr : haxe_macro_ExprDef.EBlock([bodyExpr]), pos : { file : "src/core/output/OutputManager.hx", min : 1055, max : 1082}}, params : []}), pos : { file : "src/core/output/OutputManager.hx", min : 1011, max : 1082}});
		}
	}
